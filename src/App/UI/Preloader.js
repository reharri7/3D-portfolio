...
import { appStateStore, deviceTypeStore } from '../Utils/Store.js'

export default class Preloader {
    constructor() {
        this.assetStore = assetStore;
        this.deviceTypeStore = deviceTypeStore;
        ...
        this.deviceTypeStore.subscribe((state) => {
            console.log('Device has touch screen: ', state);
        });
        deviceTypeStore.setState({isMobile: hasTouchScreen || isMobileDevice});
